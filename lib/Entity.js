...
Entity.prototype.update = function() {
  ...
  var orientation = Math.atan2(this.vy, this.vx);
  var frictionAX = -Constants.FRICTION *
      this.deltaTimeScaled * Math.cos(orientation);
  var frictionAY = -Constants.FRICTION *
      this.deltaTimeScaled * Math.sin(orientation);
  ...
  this.x += this.vx * this.deltaTimeScaled;
  this.y += this.vy * this.deltaTimeScaled;

...
Entity.prototype.update = function() {
  ...
  var frictionAX = Util.getSign(this.vx) * Constants.FRICTION * deltaTimeScaled;
  var frictionAY = Util.getSign(this.vy) * Constants.FRICTION * deltaTimeScaled;
  ...
  console.log('Player(position=' + this.x.toFixed(2) + ',' + this.y.toFixed(2) + ', velocity=' + this.vx.toFixed(2) + ', ' + this.vy.toFixed(2) + ')');
};
